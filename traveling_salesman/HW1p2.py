...
def get_distance_matrix(dist_filepath = 'distances.txt'):
    ...
    '''
    distances = pd.read_csv(dist_filepath, header=None)
...
if __name__ == '__main__':
    dist_filepath =  #Enter path to distances.csv file
    loc_filepath =  # Enter path to locations.tst file
